...
guiutils.draw_rect = function(x, y, width, height, color)
{
...
guiutils.fill_rect = function(x, y, width, height, color)
{
    gui.ctx.fillStyle = color;
    gui.ctx.fillRect(x, y, width, height);
}

guiutils.draw_text_centered = function(x, y, text, color)
{
...
guiutils.fill_text_centered = function(x, y, text, color, fillColor)
{
    gui.ctx.font="10px Arial";
...
guiutils.draw_circle = function(center_x, center_y, radius, color)
{
...
guiutils.fill_circle = function(center_x, center_y, radius, color)
{
    if (color == null) color = "#ff0000";
    gui.ctx.beginPath();
    gui.ctx.arc(center_x, center_y, radius, 0, 2 * Math.PI, false);
...
guiutils.draw_line = function(x1, y1, x2, y2, color)
{
    if (color == null) color = "#ff0000";
