...
{
    api_rooms.service_call("http://" + api_rooms.node_host + ":" + api_rooms.node_port + "/node_game/actor_call/" + api_rooms.game_id + "/" + api_rooms.token + "/" + actor_id + "/" + command, args, callback);
}
